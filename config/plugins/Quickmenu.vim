" skywind3000/quickmenu.vim (now mine: CharlesGueunet/quickmenu.vim)
...
if s:loaded == 0
  ...
  call g:quickmenu#append('Checkout'          , 'call quickmenu#bottom(10)' , 'show/change current git branch' , '' , 0 , 'c')
  ...
  call g:quickmenu#append('All    '        , ':let g:cmake_build_target="all"'     , 'target set to all (default)'      , ''    , 0 , 'I')
  call g:quickmenu#append('Parallel build' , ':let g:make_arguments="-j4"'         , 'set the number of thread to 4'    , ''    , 0 , 'p')
  call g:quickmenu#append('Sequential build' , ':let g:make_arguments="-j1"'         , 'set the number of thread to 1'  , ''    , 0 , 'P')
